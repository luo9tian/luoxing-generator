...
import com.luojiu.maker.template.model.*;
...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir");
        String originProjectPath = new File(projectPath).getParent() + File.separator + "luoxing-generator-demo-projects/acm-template";
        String inputFilePath1 = "src/com/luojiu/acm";
//        String originProjectPath = new File(projectPath).getParent() + File.separator + "yuzi-generator-demo-projects/springboot-init";
//        String inputFilePath1 = "src/main/java/com/luojiu/springbootinit/common";
...
//        templateMakerFileConfig.setFileGroupConfig(fileGroupConfig);
        ...
        long id = makeTemplate(meta, originProjectPath, templateMakerFileConfig, templateMakerModelConfig,null, 1893538485642485760L);
